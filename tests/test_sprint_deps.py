        ...
        child_a = init_new_task(
            {
                ...
                "title": "Dep A",
                "description": "first",
                    "acceptanceCriteria": ["First dependency is delivered"],
                    "scope": "First dependency",
                    "testPlan": "Run dependency unit tests",
                "status": "Backlog",
                "priority": 50,
                "requiresDev": True,
            }
        ...
        child_b = init_new_task(
            {
                ...
                "title": "Dep B",
                "description": "second",
                    "acceptanceCriteria": ["Second dependency is delivered"],
                    "scope": "Second dependency",
                    "testPlan": "Run dependency unit tests",
                "status": "Backlog",
                "priority": 50,
                "requiresDev": True,
        ...
        child = init_new_task(
            {
                ...
                "title": "Child",
                "description": "c",
                    "acceptanceCriteria": ["Child is delivered"],
                    "scope": "Child dependency",
                    "testPlan": "Run dependency unit tests",
                "status": "Backlog",
                "requiresDev": True,
            }
        ...
        child = init_new_task(
            {
                ...
                "title": "Dep",
                "description": "d",
                    "acceptanceCriteria": ["Dependency is delivered"],
                    "scope": "Dependency child",
                    "testPlan": "Run dependency unit tests",
                "status": "Backlog",
                "requiresDev": True,
            }
